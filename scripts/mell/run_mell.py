...
def load_label_emb(task_name):
    with open('/apsarapangu/disk3/zhangtaolin.ztl/MeLL_pytorch/data/label_dict.json', 'r') as file:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_dir_base", default='/apsarapangu/disk3/zhangtaolin.ztl/MeLL_pytorch/checkpoint', type=str, help="The base dir of checkpoints")
    parser.add_argument("--outputs", default='/apsarapangu/disk3/zhangtaolin.ztl/MeLL_pytorch/output/output_con.txt', type=str, help="The output Table")
