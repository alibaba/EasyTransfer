...
-Dconfig=scripts/meta_finetune/config/meta_finetune_pair.json
-Dtables='odps://sre_mpi_algo_dev/tables/mnli_train_weights,odps://sre_mpi_algo_dev/tables/mnli_eval_weights'
-Dscript=${job_path}
